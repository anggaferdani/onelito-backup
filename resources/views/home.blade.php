...
<div class="container">
      ...
      <div class="p-3 border bg-light">
        ...
        <div class="row">
          <div class="col-md-6 p-0">
            <button style="background-color:limegreen;">Order Now</button>
          </div>
          <div class="col-md-3 m-auto">
            <button style="background-color: red"><i class="fas fa-shopping-cart" style="color: white"></i></button>
          </div>
          <div class="col-md-3 m-auto">
  ...
  <h5><b>ONELITO <span style="color:red;">KOI</span></b></h5>
...
<div class="container my-5">
  <a href="#" style="color: red">Lihat lebih Banyak >></a>
</div>
