                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 p-0">
                                <p class="m-0" style="text-align: end;font-size: small">Countdown</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <p class="m-0" style="font-size:small">Harga saat ini</p>
                                <p class="m-0" style="color: red">Rp. 6.500.000</p>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <p class="m-0" style="font-size:small">Harga saat ini</p>
                                <p class="m-0" style="color: red">Rp. 5.000.000</p>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <p class="m-0" style="font-size:small">Harga saat ini</p>
                                <p class="m-0" style="color: red">Rp. 4.000.000</p>
                            </div>
