    ...
    <div class="res">
        <div class="row">
            <div class="col-6">
                ...
                <div>
                    <a class="btn btn-danger mb-3 d-block" href="/bid3" style="font-size: 12px" role="button">BID Now</a>
                </div>
            </div>
            <div class="col-6 ps-0">
                ...
                <p class="m-0" style="font-size:11px">Harga saat ini: <span class="alert-link text-danger" style="font-size:12px">Rp 5.000.000</span></p>
    ...
    <div class="web">
        <div class="row gx-5">
            ...
            <div class="row">
                ...
                <p style="font-size:30px">Harga saat ini: <span class="alert-link text-danger">Rp 5.000.000</span></p>
                <hr>
