                            ...
                            <div class="card">
                                <div class="row">
                                    <div class="col-lg-7 mx-3 my-4">
                                        <input class="form-check-input" style="font-size:large" type="checkbox"
                                            value="" id="Pilih Semua">
                                        <label class="form-check-label" for="Pilih Semua">
                                            Pilih Semua
                                        </label>
                                        <hr>
                                        <div class="form-check">
                                            <input class="form-check-input my-xxl-4 rounded-0" style="font-size: large"
                                            ...
                                            <label class="form-check-label w-100" for="flexRadioDefault1">
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        <p class="m-0" style="font-size:20px">Bio Tube Bacteria
                                                            House
                                                            Media Filter</p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <p class="my-xl-3 text-center">
                                                                Pindahkan ke Wishlist | <span><button class="border-0"
                                                        ...
                                                        <div class="col-3">
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <button type="input" class="border-0 p-3"
                                                                    style="background-color: transparent">1</button>
                                                                <button type="button" class=" border-0 btn-light ">
                                        ...
                                        <hr>
                                        <div class="form-check">
                                            <input class="form-check-input my-xxl-4 rounded-0"
                                                style="font-size: large" type="radio" name="flexRadioDefault"
                                                id="flexRadioDefault1">
                                            <label class="form-check-label w-100" for="flexRadioDefault1">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <a href="/detail_onelito_store"><img src="img/uniring.jpeg"
                                                                alt="bio media" class="card-img-top"
                                                                style="width: 80px"></a>
                                                    </div>
                                                    <div class="col-9">
                                                        <p class="m-0" style="font-size:20px">Uniring rubber hose
                                                            /selang aerasi</p>
                                        ...
                                        <div class="card" style="width: 17rem;">
                                            <div class="card-body ">
                                                ...
                                                <a class="btn btn-secondary w-100 justify-content-between"
                                                    href="" role="button">Pesan Sekarang (0)</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-2">
                                                            <a href="/detail_onelito_store"><img
                                                                    src="img/bio_media.png" alt="bio media"
                                                                    class="card-img-top" style="width: 80px"></a>
                                                        </div>
                                                        <div class="col-9">
                                                            <p class="m-0" style="font-size:20px">Bio Tube Bacteria
                                                                House Media Filter</p>
                                                            <p class="m-0"><b>Rp. 1.300.000</b></p>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-3">
                                                            ...
                                                            <div class="col-6">
                                                                <p class="my-xl-3 text-center">
                                                                    Pindahkan ke Wishlist | <span><button
                                                                            class="border-0"
                                                                            style="background-color: transparent"><i
                                                                                class="fa-regular fa-trash-can"></i></button></span>
                                                                </p>
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label w-100" for="flexRadioDefault1">
                                                    <div class="row">
                                                        <div class="col-2">
                                                            <a href="/detail_onelito_store"><img
                                                                    src="img/uniring.jpeg" alt="bio media"
                                                                    class="card-img-top" style="width: 80px"></a>
                                                        </div>
                                                        <div class="col-9">
                                                            <p class="m-0" style="font-size:20px">Uniring rubber
                                                                hose /selang aerasi</p>
                                                            <p class="m-0"><b>Rp. 580.000</b></p>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-3">
