        ...
        <div class="row pt-3">
            <div class="col-10 px-4">
                <button class="nav-link active bg-tranparent text-body" style="background-color: white" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
                    <div class="row">
                        <div class="col-3">
                            <i class="fa-solid fa-circle-user" style="font-size: xx-large"></i>
                        </div>
                        <div class="col-9">
            ...
            <div class="col-1 px-1 py-2" style="font-size: 22px">
                <a href="/login"><i class='bx bx-x-circle text-danger'></i></a>
            </div>
            <div class="d-flex nav nav-pills container overflow-auto" style="width: 113vw" >
                <button class=" btn-outline-secondary rounded-pill mr-2" aria-selected="false">
                    <i class='bx bx-menu-alt-left'></i> Filter
                </button>
                <button style="font-size: 11px" class="btn btn-outline-secondary rounded-pill mr-2" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                    Shopping cart
                </button>
                <button style="font-size: 11px" class="btn btn-outline-secondary rounded-pill mr-2" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                    WishList
                </button>
                <button style="font-size: 11px" class="btn btn-outline-secondary rounded-pill mr-2" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                    Purchase history
                </button>
            </div>
        </div> 
