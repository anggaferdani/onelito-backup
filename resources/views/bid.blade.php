            ...
            <div class="row">
                ...
                <div class="col-6 ps-0">
                    ...
                    <p style="font-size:10px" class="m-0">Kelipatan BID: <span class="alert-link text-danger"
                            style="font-size: 11px">Rp 100.000</span></p>
                ...
                <div class="col-8">
                    ...
                    <form class="row">
                        ...
                        <div class="col-3" style="padding-left: 0">
                            <button type="submit" class="btn btn-danger mb-3 w-100 justify-content-between">BID
                                AUCTION</button>
                        </div>
                    </form>
                    ...
                    <form class="row">
                        <div class="col-9" style="padding-right: 0;">
                            <input type="email" class="form-control" id="exampleFormControlInput1"
                                placeholder="Nominal Max Auto BID">
                        </div>
                        <div class="col-3" style="padding-left: 0">
                            <button type="submit" class="btn btn-danger mb-3 w-100 justify-content-between">AUTO
                                BID</button>
                        </div>
                    </form>
                </div>
