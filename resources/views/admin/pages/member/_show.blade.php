    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" id="modalShowBody">
            ...
            <div class="form-group">
                <label for="show_provinsi">Provinsi</label>
                <input readonly type="text" id="show_provinsi" class="form-control" name="show_provinsi" placeholder="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="show_kecamatan">Kecamatan</label>
                <input readonly type="text" id="show_kecamatan" class="form-control" name="show_kecamatan" placeholder="">
            </div>
            <div class="form-group">
                <label for="show_kelurahan">Kelurahan</label>
                <input readonly type="text" id="show_kelurahan" class="form-control" name="show_kelurahan" placeholder="">
            </div>
            <div class="form-group">
                <label for="show_kode_pos">Kode Pos</label>
                <input readonly type="text" id="show_kode_pos" class="form-control" name="show_kode_pos" placeholder="">
            </div>
        </div>
