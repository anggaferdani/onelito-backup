...
<div class="container">
    <h5>Rules Auction</h5>
    <p class="m-0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet odio atque quasi dolore ducimus distinctio dolor eum magnam, </p>
    <p class="m-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. At atque mollitia nostrum neque sint commodi</p>
    <p class="m-0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet odio atque quasi dolore ducimus distinctio dolor eum magnam, </p>
    <p class="m-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. At atque mollitia nostrum neque sint commodi</p>

    <div class="my-5">
        <p style="color: red">Lorem ipsum dolor sit amet consectetur adipisicing elit. At atque mollitia nostrum neque sint commodi</p>
    </div>
            ...
            <div class="col-6 col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6 p-0 px-sm-2">
                                <a href="/bid2" class="btn btn-danger w-100 d-flex justify-content-between p-1" style="font-size: 60%">BID NOW <span><i class="fa-solid fa-circle-chevron-right"></i></span></a>
                            </div>
                            <div class="col-6 col-md-6 pe-0 px-sm-2">
                                <a href="/detail2" class="btn btn-secondary w-100 d-flex justify-content-between px-1 p-1" style="font-size: 60%">DETAIL <span><i class="fa-solid fa-circle-chevron-right"></i></span></a>
                            </div>
                            <div class="col-9 p-0">
                                <a href="#" class="btn btn-light w-100 d-flex justify-content-between">VIDEO <span><i class="fa-solid fa-circle-chevron-right"></i></span></a>
                            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6 p-0 px-sm-2">
                                <a href="/bid3" class="btn btn-danger w-100 d-flex justify-content-between p-1" style="font-size: 60%">BID NOW <span><i class="fa-solid fa-circle-chevron-right"></i></span></a>
                            </div>
                            <div class="col-6 col-md-6 pe-0 px-sm-2">
                                <a href="/detail3" class="btn btn-secondary w-100 d-flex justify-content-between px-1 p-1" style="font-size: 60%">DETAIL <span><i class="fa-solid fa-circle-chevron-right"></i></span></a>
                            </div>
                            <div class="col-9 p-0">
                                <a href="#" class="btn btn-light w-100 d-flex justify-content-between">VIDEO <span><i class="fa-solid fa-circle-chevron-right"></i></span></a>
                            </div>
            ...
            <div class="col-6 col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6 p-0 px-sm-2">
                                <a href="/bid4" class="btn btn-danger w-100 d-flex justify-content-between p-1" style="font-size: 60%">BID NOW <span><i class="fa-solid fa-circle-chevron-right"></i></span></a>
                            </div>
                            <div class="col-6 col-md-6 pe-0 px-sm-2">
                                <a href="/detail4" class="btn btn-secondary w-100 d-flex justify-content-between px-1 p-1" style="font-size: 60%">DETAIL <span><i class="fa-solid fa-circle-chevron-right"></i></span></a>
                            </div>
                            <div class="col-9 p-0">
                                <a href="#" class="btn btn-light w-100 d-flex justify-content-between">VIDEO <span><i class="fa-solid fa-circle-chevron-right"></i></span></a>
                            </div>
